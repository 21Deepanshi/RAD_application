namespace LINQ3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //IEnumerable<int> integerListConcat = integerList1.Concat(integerList2); //cannot return the list
            //foreach (var item in integerListConcat)
            //    Console.WriteLine(item);

            //created two emp and the connected to the employee list
            ...
            ////Repeat
            //var strCollection = Enumerable.Repeat<string>("Placeholder", 100);
